...
Q_CONSTINIT static const qt_meta_stringdata_CLASSLoginPageENDCLASS_t qt_meta_stringdata_CLASSLoginPageENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(10, 15),  // "loginSuccessful"
        QT_MOC_LITERAL(26, 0),  // ""
        QT_MOC_LITERAL(27, 8),  // "username"
        QT_MOC_LITERAL(36, 20)   // "onLoginButtonClicked"
    },
    "LoginPage",
    "loginSuccessful",
    "",
...
void LoginPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &LoginPage::loginSuccessful; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
